<div class="container">
		...
		<form action="" method="post">
			...
			<div class="input-group">
				...
				<select name="productGender" required>
					...
					<?php foreach ($allProductGenders as $productGender): ?>
						<option value="<?php Cerbarus::echoEscaped($productGender['o_gender']); ?>"><?php Cerbarus::echoEscaped($productGender['o_gender']); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
	...
	<?php if ((isset($_POST['isSent'])) && (empty($validation) == true) && (empty($searchResults) == false)): ?>
		...
		<table class="searchResultTable">
			...
			<tbody>
				<?php foreach($searchResults as $searchResult): ?>
					<tr>
						<td><?php echo $searchResult['o_productDescription']; ?></td>
						<td><?php echo $searchResult['o_brand']; ?></td>
						<td><?php echo $searchResult['o_quantity']; ?></td>
						<td><?php echo $searchResult['o_location']; ?></td>
					</tr>
				<?php endforeach; ?>
			</tbody>
		</table>
		...
		<div style="display: flex; flex-wrap: nowrap; width: 100%;">
			<a href="/search.php?type=<?php Cerbarus::echoEscaped($_GET['type']); ?>" style="text-align: center;" class="button <?php Cerbarus::echoEscaped($_GET['type']); ?>"><< Back</a>
			<a href="/index.php" style="text-align: center; margin-left: 3em;" class="button <?php Cerbarus::echoEscaped($_GET['type']); ?>">Home</a>
		</div>
